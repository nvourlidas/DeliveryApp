<template>
  ...
  <transition name="fade">
    <div v-if="regionA" class="fading-div">
      ...
      <CButton :color="bcolorC" @click="visibleC = !visibleC, visibleB = false, visibleA = false, color()">Σήμερα
      </CButton>
      <CButton :color="bcolorA" @click="visibleA = !visibleA, visibleB = false, visibleC = false, color()"
        style="margin: 2%;">Τρέχων Μήνας</CButton>
      <CButton :color="bcolorB" @click="visibleB = !visibleB, visibleA = false, visibleC = false, color()"> Από Πάντα
      </CButton>
      <CCollapse :visible="visibleA">
        <CRow>
          <CCol :xs="4" v-for="(entry, id) in Ctable" :item="entry" :key="id">
            ...
            <CWidgetStatsC v-if="entry.region == region" class="mb-3" title="Dels" inverse color="info">
              ...
              <template #value>
                ...
                <CButton color="success" @click="showModal(entry.userid, 2)">Λεπτομέριες</CButton>
              </template>
            </CWidgetStatsC>
      ...
      <CCollapse :visible="visibleB">
        <CRow>
          <CCol :xs="4" v-for="(entry, id) in table" :item="entry" :key="id">
            ...
            <CWidgetStatsC v-if="entry.region == region" class="mb-3" title="Dels" inverse color="info">
              ...
              <template #value>
                Ολοκληρωμένες: {{ entry.olorders }}<br />
                Συνολικό Ποσό: {{ entry.tziros }}&euro;<br />
                <CButton color="success" @click="showModal(entry.userid, 1)">Λεπτομέριες</CButton>
              </template>
            </CWidgetStatsC>
      ...
      <CCollapse :visible="visibleC">
        <CRow>
          <CCol :xs="4" v-for="(entry, id) in Ttable" :item="entry" :key="id">
            ...
            <CWidgetStatsC v-if="entry.region == region" class="mb-3" title="Dels" inverse color="info">
              ...
              <template #value>
                ...
                Ολοκληρωμένες: {{ entry.olorders }}<br />
                Συνολικό Ποσό: {{ entry.tziros }}&euro;<br />
                <CButton color="success" @click="showModal(entry.userid, 3)">Λεπτομέριες</CButton>
              </template>
            </CWidgetStatsC>
