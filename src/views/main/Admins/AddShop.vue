<template>
    <div>
        <CAlert color="success" :visible="liveExampleVisible">Επιτυχημέμη Εισαγωγή Καταστήματος</CAlert>
        <CCard>
            <CForm @submit.prevent="AddUser" ref="orderform">
                <h2 style="text-align: center;">Νέο Κατάστημα</h2>
                <CCardbody class="card">
                    ...
                    <CFormInput label="Όνομα Κατατήματος" v-model="name" name="name" size="lg" horizontal
                ...
                <CCardFooter style="text-align: center">
                    <CButton type="submit" size="bg" color="primary">
                        <CIcon name="cil-check-circle" /> Εισαγωγή Καταστήματος
                    </CButton>
                </CCardFooter>
            </CForm>
        </CCard>
