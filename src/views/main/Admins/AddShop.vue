<template>
    <div>
        <CAlert color="success" :visible="liveExampleVisible"
              >Επιτυχημέμη Εισαγωγή Καταστήματος</CAlert
            >
        <CCard>
            ...
            <CButton  type="submit" size="bg" color="primary" ><CIcon name="cil-check-circle"/> Εισαγωγή Καταστήματος</CButton>
          </CCardFooter>
            </CForm>
        </CCard>
