<template>
    <div>
        <CAlert color="success" :visible="liveExampleVisible">Επιτυχημέμη Εισαγωγή Διανομέα</CAlert>
        <CCard>
            <CForm @submit.prevent="AddUser" ref="orderform">
                ...
                <CCardbody class="card">
                    <CAlert color="danger" :visible="liveExampleVisible3" style="width: 70%">Το πεδίο δεν μπορεί να είναι
                        άδειο</CAlert>
                    <CFormInput label="Username" v-model="username" name="username" size="lg" horizontal
                        placeholder="Προσθήκη Username..." style="width: 70%; margin-bottom: 1rem;" />
                    <CAlert color="danger" :visible="liveExampleVisible2" style="width: 70%">Αυτό το πεδίο πρέπει να είναι
                        αριθμός</CAlert>
                    <CFormInput label="Password" v-model="password" name="password" size="lg" horizontal
                        placeholder="Προσθήκη Password..." style="width: 70%; margin-bottom: 1rem;" />
                    <CFormInput label="Όνομα Χρήστη" v-model="name" name="name" size="lg" horizontal
                        placeholder="Προσθήκη Ονόματος..." style="width: 70%; margin-bottom: 1rem;" />
                    <CFormInput label="Επίθετο Χρήστη" v-model="surname" name="surname" size="lg" horizontal
                        placeholder="Προσθήκη Επιθέτου..." style="width: 70%; margin-bottom: 1rem;" />
                ...
                <CCardFooter style="text-align: center">
                    <CButton type="submit" size="bg" color="primary">
                        <CIcon name="cil-check-circle" /> Εισαγωγή Διανομέα
                    </CButton>
                </CCardFooter>
            </CForm>
        </CCard>
