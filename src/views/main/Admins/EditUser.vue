<template>
  <CButton :color="bcolorA" @click="visibleA = !visibleA, visibleB = false, color()" style="margin-right: 2%;">Καταστήματα
  </CButton>
        ...
        <div v-for="(entry, id) in table" :item="entry" :key="id">
          <CCard class="mt-3" v-if="entry.usertype == 3">
            ...
            <CCardBody>
              <div>
                <div class="cont">
                  <h3 class="element"><b>Username:</b>
                    <div v-if="uv == true">{{ entry.username }}</div>
                  </h3>
                ...
                <div class="cont">
                  <h3 class="element"><b>Όνομα Καταστήματος:</b>
                    <div v-if="uo == true">{{ entry.name }}</div>
                  </h3>
                ...
                <div class="cont">
                  <h3 class="element"><b>Password:</b>
                    <div v-if="pv == true"> {{ entry.password }}</div>
                  </h3>
            ...
            <CCardFooter>
              <CButton color="danger" @click="delete1(entry.userid)">
          ...
          <CCard class="mt-3" v-if="entry.usertype == 2">
            ...
            <CCardBody>
              <div>
                ...
                <div class="cont">
                  <h3 class="element"><b>Επίθετο:</b>
                    <div v-if="su == true">{{ entry.surname }}</div>
                  </h3>
