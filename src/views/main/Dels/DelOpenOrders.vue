                        ...
                        <div class="card1">
                            ...
                            <div class="right-div">
                                ...
                                <div v-if="entry.state == 1">
                                    <CButton color="warning" shape="rounded-pill" @click="UpdateStatus(entry.orderid)">
                                        Aποδοχή Παραγγελίας</CButton>
                                </div>
                                    ...
                                    <div v-for="e in entry.users" :key="e">
                                        ...
                                        <div v-if="e.userid == userid">
                                            <CButton color="success" shape="rounded-pill"
                                                @click="UpdateStatus2(entry.orderid)">Ολοκλήρωση Παραγγελίας</CButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
